...
const onBossDeath = (boss, type) => {
    ...
    let a = 0;
    if (type === 'YELLOW') a = 59.5;
    if (type === 'GREEN') a = 29.5;
    if (type === '1Goblin') a = 15;
    if (type === '2Goblin') a = 15;
    if (type === 'MINAYELLOW') a = 59.5;
    if (type === 'BAU_YELLOW') a = 59.5;
    if (type === 'BAURED') a = 29.5;
    if (type === 'LIDERI') a = 29.5;
    if (type === 'LIDERII') a = 59.5;
    if (type === 'TESTE') a = 0.2;
    BOSSES[boss] = {
        
        resetTime: (new Date().getTime() + (a * 60 * 1000)),
